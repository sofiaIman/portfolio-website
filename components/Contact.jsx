  ...
  return (
    <div id="contact" className="w-full bg-slate-800">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row gap-8 shadow-xl shadow-blue-300 bg-slate-800 mt-4">
          <div className="w-full md:w-1/2 h-full rounded-xl p-4">
            ...
            />
            <p className="pt-2 pb-8 text-gray-300">
          ...
          <div className="w-full md:w-1/2 h-full rounded-xl p-4 ">
            <div className="p-4 text-left">
              <form
                action="https://getform.io/f/8d2532ab-81fb-40f5-83f8-baf82c85874f"
                method="POST"
              >
                <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                  <div className="flex flex-col">
                    <label className="capitalize text-sm py-2 text-gray-300 font-light">
                      name
                    </label>
                    <input
                      type="text"
